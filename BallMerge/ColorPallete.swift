...
struct ColorPallete {
    ...
    public static let BACKGROUND = UIColor(hexString: "#F5FFFA")
    public static let TEXT = UIColor(hexString: "#2F4F4F")
    
//    public static let PUZZLE_GRID = UIColor(hexString: "#ffffff")
    public static let WALL = UIColor(hexString: "#322C3E")
    public static let TEXT_HEADER = UIColor(hexString: "#2F4F4F")
    
    
    public static let PUZZLE_BACK = UIColor(hexString: "#00FF7F")
