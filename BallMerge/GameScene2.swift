...
//  Copyright © 2020 Gigyago Zuni. All rights reserved.
//
...
class GameScene2 : SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        title.fontSize = 75
        title.text = "Ball Merge"
        title.fontColor = ColorPallete.TEXT_HEADER
    ...
    private func initOptionsPanel() -> SKNode {
        ...
        themeLabel.text = "Game Created by Gigyago Zuni"
        themeLabel.fontSize = 18
        themeLabel.color = .red
        themeLabel.fontColor = .red
        theme.addChild(themeLabel)
        
        let squareOne = SKShapeNode(rectOf: CGSize(width: scale/4/2.5, height: scale/4/2.5), cornerRadius: 10)
...
//        squareOne.strokeColor = ColorPallete.SQUARE_ONE.darker(by: 50)
        ...
        let nodeOne = SKSpriteNode.init(imageNamed: "football")
        nodeOne.name = "das"
        nodeOne.size = CGSize(width: scale/4/2.5, height: scale/4/2.5)
        
        squareOne.addChild(nodeOne)
        ...
        let squareTwo = SKShapeNode(rectOf: CGSize(width: scale/4/2.5, height: scale/4/2.5), cornerRadius: 10)
        squareTwo.position = CGPoint(x: -scale/4/3, y: -25)
//        squareOne.fillColor = ColorPallete.SQUARE_ONE
//        squareOne.strokeColor = ColorPallete.SQUARE_ONE.darker(by: 50)
        
        let nodeTwo = SKSpriteNode.init(imageNamed: "bsaketball")
        nodeTwo.name = "das"
        nodeTwo.size = CGSize(width: scale/4/2.5, height: scale/4/2.5)
        
        squareTwo.addChild(nodeTwo)
        
        
        theme.addChild(squareTwo)
        
        
        let squareThree = SKShapeNode(rectOf: CGSize(width: scale/4/2.5, height: scale/4/2.5), cornerRadius: 10)
        squareThree.position = CGPoint(x: scale/4/3, y: -25)
//        squareOne.fillColor = ColorPallete.SQUARE_ONE
//        squareOne.strokeColor = ColorPallete.SQUARE_ONE.darker(by: 50)
        
        let nodeThree = SKSpriteNode.init(imageNamed: "volleyball")
        nodeThree.name = "das"
        nodeThree.size = CGSize(width: scale/4/2.5, height: scale/4/2.5)
        
        squareThree.addChild(nodeThree)
        
        
        theme.addChild(squareThree)
        
        
        let squareFour = SKShapeNode(rectOf: CGSize(width: scale/4/2.5, height: scale/4/2.5), cornerRadius: 10)
        squareFour.position = CGPoint(x: scale/4, y: -25)
//        squareOne.fillColor = ColorPallete.SQUARE_ONE
//        squareOne.strokeColor = ColorPallete.SQUARE_ONE.darker(by: 50)
        
        let nodeFour = SKSpriteNode.init(imageNamed: "tennis")
        nodeFour.name = "das"
        nodeFour.size = CGSize(width: scale/4/2.5, height: scale/4/2.5)
        
        squareFour.addChild(nodeFour)
        
        
        theme.addChild(squareFour)
...
//
//        let nodeTwo = SKSpriteNode.init(imageNamed: "volleyball")
//        nodeTwo.name = "das"
//        nodeTwo.size = CGSize(width: scale/4/2.5, height: scale/4/2.5)
//
//        squareOne.addChild(nodeTwo)
...
//        theme.addChild(circle)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if z {
            ...
            let msg = "Este es un juego de rompecabezas llamado fusión del mismo tipo. El objetivo del juego es que solo quede una imagen. Desliza el dedo sobre la forma para moverlos. Los botones de configuración y nivel actualmente solo se encuentran en la parte inferior de la interfaz de usuario."
            let controller = UIAlertController(title: "Versión 1.0", message: msg, preferredStyle: .alert)
    ...
    private func puzzleSolved() {
        ...
        let switchSprite = SKAction.run {
            self.nextLevelButton.fillColor = ColorPallete.PUZZLE_BACK
            self.nextLevelButton.strokeColor = UIColor.white
